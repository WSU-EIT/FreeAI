...
Note: login returned FAILED (app may require different credentials or seeded data).
...
| [runs/2026-05-14/localhost/_root/00c-login-FAILED.jpeg](showcase/runs/2026-05-14/localhost/_root/00c-login-FAILED.jpeg) | Screenshot | Login failed |
...
| [runs/2026-05-14/localhost/_root/17-forced-colors.png](showcase/runs/2026-05-14/localhost/_root/17-forced-colors.png) | A11y view | Forced colors |
