...
namespace FreeNavbarComponent.EFModels.EFModels;
...
public partial class EFDataModel : DbContext
{
    ...
    // => optionsBuilder.UseSqlite("Data Source=C:\\Working\\FreeNavbarComponent.db");
    // => optionsBuilder.UseMySQL("Server=localhost;Database=FreeNavbarComponent;User=admin;Password=admin");
    // => optionsBuilder.UseNpgsql("Host=localhost;Database=FreeNavbarComponent;Username=postgres;Password=admin");
    // => optionsBuilder.UseSqlServer("Data Source=(local);Initial Catalog=FreeNavbarComponent;Persist Security Info=True;User ID=sa;Password=saPassword;MultipleActiveResultSets=True;TrustServerCertificate=True;");
