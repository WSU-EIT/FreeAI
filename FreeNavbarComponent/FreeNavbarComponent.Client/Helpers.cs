...
using FreeNavbarComponent.Client.Pages.Settings.Users;
using FreeNavbarComponent.Client.Shared;
using Humanizer;
...
public static partial class Helpers
{
    ...
    public static async Task EditUser(Guid UserId, Delegate? OnSaved = null, string width = "auto", string height = "auto")
    {
        ...
        await DialogService.OpenAsync<FreeNavbarComponent.Client.Pages.Settings.Users.EditUser>(title, parameters, new DialogOptions() {
...
<path fill=""currentColor"" stroke=""currentColor"" d=""M84.5,13.4l147.2,21.2c5,0.7,9.4,3.6,12.1,7.9l186.6,298.8l57.5,24.1c7.6,3.2,11.9,11.4,10.1,19.5l-28.2,127
    ...
    public static async Task ManageProfile()
    {
        ...
        await DialogService.OpenAsync<FreeNavbarComponent.Client.Pages.Profile>(Text("ManageProfile"), parameters, new DialogOptions() {
            AutoFocusFirstElement = false,
            Width = "98%",
        });
    }
