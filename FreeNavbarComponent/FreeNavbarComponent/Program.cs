...
using FreeNavbarComponent.Components;
using FreeNavbarComponent.Server.Hubs;
...
namespace FreeNavbarComponent
{
    public partial class Program
    {
        public static void Main(string[] args)
        {
            ...
            try { serverReferences.Add(typeof(FreeNavbarComponent.EFModels.EFModels.User).Assembly.Location); } catch { }
            ...
            try { serverReferences.Add(typeof(FreeNavbarComponent.Client.BlazorDataModel).Assembly.Location); } catch { }
           ...
           var configurationHelperLoader = ConfigurationHelpersLoadApp(new ConfigurationHelperLoader {
            ...
            app.MapHub<freenavbarcomponentHub>("/freenavbarcomponentHub", signalRConnctionOptions => {
