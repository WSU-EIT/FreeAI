...
```powershell
.\run-a11y-showcase.ps1 -Targets FreeA11yChecker
```

This boots the app with `DatabaseType=InMemory`, scans with FreeA11yChecker Console (admin/admin), and writes results to `Docs/showcase/runs/YYYY-MM-DD/`.
