...
using FreeA11yChecker.Client.Pages.Settings.Tags;
// {{ModuleItemEnd:Tags}}
using FreeA11yChecker.Client.Pages.Settings.Users;
using FreeA11yChecker.Client.Shared;
using Humanizer;
...
public static partial class Helpers
{
    ...
    public static async Task EditUser(Guid UserId, Delegate? OnSaved = null, string width = "auto", string height = "auto")
    {
        ...
        await DialogService.OpenAsync<FreeA11yChecker.Client.Pages.Settings.Users.EditUser>(title, parameters, new DialogOptions() {
                    ...
                    if (response.IsSuccessStatusCode) {
                        ...
                        try {
                            ...
                            if (!String.IsNullOrWhiteSpace(errorBody)) {
                                await ConsoleLog("Error Details: " + errorBody);
                            }
                        } catch { }
                    }
                }
