...
public partial class Program
{
    ...
    {
        WebApplicationBuilder output = builder;

        // Register the scanner background service so it starts automatically when the app launches.
        output.Services.AddHostedService<ScannerBackgroundService>();
    ...
    public static ConfigurationHelperLoader ConfigurationHelpersLoadApp(ConfigurationHelperLoader loader, WebApplicationBuilder builder)
    {
        ...
        output = LoadAppConfiguration(output, builder);
