...
| Status | ✅ 200 |
| HTML Size | 83.4 KB |
| Screenshots | 18 (2.6 MB) |
| Images | 0 |
| Images Missing Alt | 0 |
| A11y Violations | Warning 4 |
| Critical | 0 |
| Serious | 3 |
| Moderate | 1 |
| Minor | 0 |
...
|--:|------|:--------:|:---------:|:---:|:---:|:---:|:---:|---------|
| 1 | link-name | serious | medium 1/4 | found | --- | --- | --- | `<a class="nav-link" data-bs-toggle="offcanvas" href="#off...` |
| 2 | scrollable-region-focusable | serious | medium 1/4 | found | --- | --- | --- | `<main role="main" id="main-content">` |
| 3 | input_label_exists | serious | medium 1/4 | --- | --- | --- | found | `<a aria-controls="offcanvasUserMenu" role="button" href="...` |
| 4 | aria_content_in_landmark | moderate | medium 1/4 | --- | --- | --- | found | `<a href="#main-content" class="visually-hidden-focusable">` |
...
| File | Description |
|------|-------------|
| `01-page-load-00000ms.png` | Page Load +0ms (112.4 KB) |
| `02-page-expanded.jpeg` | page-expanded (321.6 KB) |
| `03-axe-overlay.png` | axe-overlay (117.9 KB) |
| `04-quickpeek-overlay.png` | quickpeek-overlay (170.1 KB) |
| `05-htmlcs-overlay.png` | htmlcs-overlay (117.2 KB) |
| `06-ibm-overlay.png` | ibm-overlay (118.5 KB) |
| `07-structure-overlay.png` | structure-overlay (166.0 KB) |
| `07b-wireframe-blueprint.png` | wireframe-blueprint (111.4 KB) |
| `08-cvd-protanopia.png` | cvd-protanopia (126.0 KB) |
| `09-cvd-deuteranopia.png` | cvd-deuteranopia (126.3 KB) |
| `10-cvd-tritanopia.png` | cvd-tritanopia (126.3 KB) |
| `11-cvd-achromatopsia.png` | cvd-achromatopsia (123.2 KB) |
| `12-cvd-protanomaly.png` | cvd-protanomaly (126.0 KB) |
| `13-cvd-deuteranomaly.png` | cvd-deuteranomaly (126.5 KB) |
| `14-cvd-tritanomaly.png` | cvd-tritanomaly (126.6 KB) |
| `15-screenreader-view.png` | screenreader-view (281.2 KB) |
| `16-reduced-motion.png` | reduced-motion (119.6 KB) |
| `17-forced-colors.png` | forced-colors (114.1 KB) |
