...
> **URL:** https://localhost:7046/Account/Manage/Email  
> **Status:** ✅ 200  
...
| Status | ✅ 200 |
| HTML Size | 7.7 KB |
| Screenshots | 17 (1017.2 KB) |
| Images | 0 |
| Images Missing Alt | 0 |
| A11y Violations | Warning 11 |
| Critical | 0 |
| Serious | 7 |
| Moderate | 4 |
| Minor | 0 |
...
<tr>
<td align="center" width="50%">
<a href="04-wave-overlay.png">
<img src="04-wave-overlay.png" width="400" alt="wave-overlay" />
</a>
...
|--:|------|:--------:|:---------:|:---:|:---:|:---:|:---:|---------|
| 1 | skip-link | moderate | high 1/4 | --- | found | --- | --- |  |
| 2 | aria_form_label_unique | serious | medium 1/4 | --- | --- | --- | found | `<form b-qa4lg9le9h="" method="post" action="Account/Logout">` |
| 3 | input_label_before | serious | medium 1/4 | --- | --- | --- | found | `<input style="" disabled="" placeholder="Enter your email...` |
| 4 | div-button | serious | medium 1/4 | --- | found | --- | --- | `<div class="nav-scrollable" onclick="document.querySelect...` |
| 5 | aria_eventhandler_role_valid | serious | medium 1/4 | --- | --- | --- | found | `<div b-qa4lg9le9h="" onclick="document.querySelector('.na...` |
| 6 | aria_landmark_name_unique | moderate | medium 1/4 | --- | --- | --- | found | `<form action="/Account/Manage/Email" method="post" id="se...` |
| 7 | aria_content_in_landmark | moderate | medium 1/4 | --- | --- | --- | found | `<a b-qa4lg9le9h="" href="" class="navbar-brand">` |
...
| File | Description |
|------|-------------|
| `01-page-load-00000ms.png` | Page Load +0ms (56.2 KB) |
| `03-axe-overlay.png` | axe-overlay (54.2 KB) |
| `04-wave-overlay.png` | wave-overlay (74.4 KB) |
| `05-htmlcs-overlay.png` | htmlcs-overlay (54.6 KB) |
| `06-ibm-overlay.png` | ibm-overlay (56.1 KB) |
| `07-structure-overlay.png` | structure-overlay (92.0 KB) |
| `07b-wireframe-blueprint.png` | wireframe-blueprint (46.6 KB) |
| `08-cvd-protanopia.png` | cvd-protanopia (60.6 KB) |
| `09-cvd-deuteranopia.png` | cvd-deuteranopia (61.7 KB) |
| `10-cvd-tritanopia.png` | cvd-tritanopia (62.1 KB) |
| `11-cvd-achromatopsia.png` | cvd-achromatopsia (55.0 KB) |
| `12-cvd-protanomaly.png` | cvd-protanomaly (60.5 KB) |
| `13-cvd-deuteranomaly.png` | cvd-deuteranomaly (62.0 KB) |
| `14-cvd-tritanomaly.png` | cvd-tritanomaly (62.4 KB) |
| `15-screenreader-view.png` | screenreader-view (52.8 KB) |
| `16-reduced-motion.png` | reduced-motion (59.1 KB) |
| `17-forced-colors.png` | forced-colors (46.8 KB) |
