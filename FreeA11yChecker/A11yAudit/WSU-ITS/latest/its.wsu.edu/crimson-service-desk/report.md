...
|--:|------|:--------:|:---------:|:---:|:---:|:---:|:---:|---------|
| 1 | aria_id_unique | serious | medium 1/4 | --- | --- | --- | found | `<svg aria-labelledby="title" role="img" title="month" sty...` |
| 2 | image-alt | serious | medium 1/4 | --- | found | --- | --- | `<img height="1" width="1" style="display:none" src="https...` |
| 3 | aria_banner_single | serious | medium 1/4 | --- | --- | --- | found | `<header aria-label="WSU system" class="wsu-header-global ...` |
| 4 | figure_label_exists | moderate | medium 1/4 | --- | --- | --- | found | `<figure class="aligncenter size-large">` |
...
| `07b-wireframe-blueprint.png` | wireframe-blueprint (1.1 MB) |
| `08-cvd-protanopia.png` | cvd-protanopia (1.1 MB) |
| `09-cvd-deuteranopia.png` | cvd-deuteranopia (1.2 MB) |
| `10-cvd-tritanopia.png` | cvd-tritanopia (1.1 MB) |
| `11-cvd-achromatopsia.png` | cvd-achromatopsia (888.5 KB) |
...
| `15-screenreader-view.png` | screenreader-view (460.6 KB) |
