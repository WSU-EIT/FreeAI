...
| 2 | aria_banner_single | serious | medium 1/4 | --- | --- | --- | found | `<header aria-label="WSU system" class="wsu-header-global ...` |
| 3 | aria_content_in_landmark | moderate | medium 1/4 | --- | --- | --- | found | `<a href="#wsu-site-menu" class="wsu-skip-to-main skip-to-...` |
| 4 | link-pdf | moderate | medium 1/4 | --- | found | --- | --- | `<a href="https://its.wsu.edu/documents/2023/10/its-organi...` |
| 5 | fieldset-missing | moderate | medium 1/4 | --- | found | --- | --- | `<input class="wsu-search-options__option-input" type="rad...` |
...
| `11-cvd-achromatopsia.png` | cvd-achromatopsia (1.0 MB) |
| `12-cvd-protanomaly.png` | cvd-protanomaly (1.7 MB) |
| `13-cvd-deuteranomaly.png` | cvd-deuteranomaly (1.7 MB) |
| `14-cvd-tritanomaly.png` | cvd-tritanomaly (1.7 MB) |
| `15-screenreader-view.png` | screenreader-view (285.4 KB) |
| `16-reduced-motion.png` | reduced-motion (1.7 MB) |
| `17-forced-colors.png` | forced-colors (1.7 MB) |
