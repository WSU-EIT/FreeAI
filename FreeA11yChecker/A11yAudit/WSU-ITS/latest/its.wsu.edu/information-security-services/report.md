...
| 4 | fieldset-missing | moderate | medium 1/4 | --- | found | --- | --- | `<input class="wsu-search-options__option-input" type="rad...` |
...
| File | Description |
|------|-------------|
| `01-page-load-00000ms.png` | Page Load +0ms (971.8 KB) |
| `03-axe-overlay.png` | axe-overlay (1.1 MB) |
| `04-quickpeek-overlay.png` | quickpeek-overlay (1.2 MB) |
...
| `15-screenreader-view.png` | screenreader-view (280.9 KB) |
| `16-reduced-motion.png` | reduced-motion (1.1 MB) |
| `17-forced-colors.png` | forced-colors (1.0 MB) |
