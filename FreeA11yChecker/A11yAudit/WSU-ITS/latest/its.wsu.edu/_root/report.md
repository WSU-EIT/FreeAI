...
| 9 | https://wpcdn.web.wsu.edu/wp-its/uploads/sites/2898/2025/02/Classroom-Photogr... | Information Technology Services
Data ... |
| 10 | https://wpcdn.web.wsu.edu/wp-its/uploads/sites/2898/2026/01/Prep-Week-in-CUB_... | Washington State University's 12-foot... |
...
|--:|------|:--------:|:---------:|:---:|:---:|:---:|:---:|---------|
| 1 | link-name | serious | medium 2/4 | found | found | --- | --- | `<a href="https://its.wsu.edu/msdata-storage/">				</a>` |
| 2 | image-alt | serious | low 1/4 | --- | found | --- | --- | `<img height="1" width="1" style="display:none" src="https...` |
| 3 | aria_banner_single | serious | low 1/4 | --- | --- | --- | found | `<header aria-label="WSU system" class="wsu-header-global ...` |
| 4 | aria_content_in_landmark | moderate | low 1/4 | --- | --- | --- | found | `<a href="#wsu-site-menu" class="wsu-skip-to-main skip-to-...` |
| 5 | fieldset-missing | moderate | low 1/4 | --- | found | --- | --- | `<input class="wsu-search-options__option-input" type="rad...` |
...
| `11-cvd-achromatopsia.png` | cvd-achromatopsia (1.3 MB) |
...
| `15-screenreader-view.png` | screenreader-view (263.1 KB) |
| `16-reduced-motion.png` | reduced-motion (2.2 MB) |
| `17-forced-colors.png` | forced-colors (2.0 MB) |
