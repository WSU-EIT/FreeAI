...
| 3 | aria_complementary_labelled | serious | medium 1/4 | --- | --- | --- | found | `<aside class="wsu-wrapper-sidebar">` |
| 4 | aria_content_in_landmark | moderate | medium 1/4 | --- | --- | --- | found | `<a href="#wsu-site-menu" class="wsu-skip-to-main skip-to-...` |
...
| File | Description |
|------|-------------|
| `01-page-load-00000ms.png` | Page Load +0ms (130.9 KB) |
| `03-axe-overlay.png` | axe-overlay (366.0 KB) |
| `04-quickpeek-overlay.png` | quickpeek-overlay (441.2 KB) |
