...
|--:|------|:--------:|:---------:|:---:|:---:|:---:|:---:|---------|
| 1 | image-alt | serious | low 1/4 | --- | found | --- | --- | `<img height="1" width="1" style="display:none" src="https...` |
| 2 | scrollable-region-focusable | serious | low 1/4 | found | --- | --- | --- | `<tr class="row-1 odd" style="height: 0px;">` |
| 3 | aria_banner_single | serious | low 1/4 | --- | --- | --- | found | `<header aria-label="WSU system" class="wsu-header-global ...` |
| 4 | element_tabbable_role_valid | moderate | low 1/4 | --- | --- | --- | found | `<th aria-label="Service Name: activate to sort column asc...` |
| 5 | aria_content_in_landmark | moderate | low 1/4 | --- | --- | --- | found | `<a href="#wsu-site-menu" class="wsu-skip-to-main skip-to-...` |
| 6 | fieldset-missing | moderate | low 1/4 | --- | found | --- | --- | `<input class="wsu-search-options__option-input" type="rad...` |
...
| File | Description |
|------|-------------|
| `01-page-load-00000ms.png` | Page Load +0ms (98.2 KB) |
| `03-axe-overlay.png` | axe-overlay (170.4 KB) |
| `04-quickpeek-overlay.png` | quickpeek-overlay (226.9 KB) |
...
| `17-forced-colors.png` | forced-colors (166.8 KB) |
