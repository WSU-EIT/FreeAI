...
> **URL:** https://registrar.wsu.edu/transcripts/  
> **Status:** ✅ 404  
...
| 2 | aria_banner_label_unique | serious | medium 1/4 | --- | --- | --- | found | `<header class="wsu-header-global">` |
| 3 | label_name_visible | serious | medium 1/4 | --- | --- | --- | found | `<a aria-label="Go to Washington State University Homepage...` |
| 4 | aria_content_in_landmark | moderate | medium 1/4 | --- | --- | --- | found | `<a href="#wsu-site-menu" class="wsu-skip-to-main">` |
| 5 | aria_landmark_name_unique | moderate | medium 1/4 | --- | --- | --- | found | `<header class="wsu-header-global">` |
...
| File | Description |
|------|-------------|
| `01-page-load-00000ms.png` | Page Load +0ms (32.1 KB) |
| `03-axe-overlay.png` | axe-overlay (30.8 KB) |
| `04-quickpeek-overlay.png` | quickpeek-overlay (45.3 KB) |
...
| `07b-wireframe-blueprint.png` | wireframe-blueprint (45.2 KB) |
| `08-cvd-protanopia.png` | cvd-protanopia (32.8 KB) |
| `09-cvd-deuteranopia.png` | cvd-deuteranopia (36.1 KB) |
| `10-cvd-tritanopia.png` | cvd-tritanopia (35.8 KB) |
| `11-cvd-achromatopsia.png` | cvd-achromatopsia (36.2 KB) |
| `12-cvd-protanomaly.png` | cvd-protanomaly (36.1 KB) |
| `13-cvd-deuteranomaly.png` | cvd-deuteranomaly (36.5 KB) |
| `14-cvd-tritanomaly.png` | cvd-tritanomaly (36.4 KB) |
| `15-screenreader-view.png` | screenreader-view (80.3 KB) |
| `16-reduced-motion.png` | reduced-motion (34.6 KB) |
| `17-forced-colors.png` | forced-colors (32.8 KB) |
