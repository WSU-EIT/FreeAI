...
| 2 | link-in-text-block | serious | low 1/4 | found | --- | --- | --- | `<a href="mailto:wsu.registration@wsu.edu" title="wsu.regi...` |
| 3 | link-name | serious | low 1/4 | --- | found | --- | --- | `<a href="mailto:official.transcripts@wsu.edu" title="Emai...` |
| 4 | label_name_visible | serious | low 1/4 | --- | --- | --- | found | `<a aria-label="Go to Washington State University Homepage...` |
| 5 | aria_content_in_landmark | moderate | low 1/4 | --- | --- | --- | found | `<a href="#wsu-site-menu" class="wsu-skip-to-main">` |
