...
| 4 | aria_content_in_landmark | moderate | low 1/4 | --- | --- | --- | found | `<a href="#wsu-content" class="wsu-skip-to-main">` |
| 5 | aria_child_valid | moderate | low 1/4 | --- | --- | --- | found | `<div aria-labelledby="degreeControlLabel" role="radiogrou...` |
| 6 | link-suspicious | moderate | low 1/4 | --- | found | --- | --- | `<a href="https://futurecoug.wsu.edu/register/form?id=4ce2...` |
| 7 | element_tabbable_role_valid | moderate | low 1/4 | --- | --- | --- | found | `<label tabindex="0" class="wsu-degree-finder__filter-sear...` |
| 8 | figure_label_exists | moderate | low 1/4 | --- | --- | --- | found | `<figure class="wp-block-image size-large wsu-image--style...` |
