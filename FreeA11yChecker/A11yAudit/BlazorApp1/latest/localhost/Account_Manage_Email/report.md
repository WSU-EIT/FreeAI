...
|--:|------|:--------:|:---------:|:---:|:---:|:---:|:---:|---------|
| 1 | aria_form_label_unique | serious | medium 1/4 | --- | --- | --- | found | `<form action="/Account/Manage/Email" method="post" id="se...` |
| 2 | input_label_before | serious | medium 1/4 | --- | --- | --- | found | `<input style="" disabled="" placeholder="Enter your email...` |
| 3 | nested-interactive | serious | medium 1/4 | found | --- | --- | --- | `<div class="nav-scrollable" role="button" tabindex="0" on...` |
| 4 | aria_content_in_landmark | moderate | medium 1/4 | --- | --- | --- | found | `<a b-qig53hgue4="" href="#main-content" class="visually-h...` |
| 5 | aria_landmark_name_unique | moderate | medium 1/4 | --- | --- | --- | found | `<form action="/Account/Manage/Email" method="post" id="se...` |
...
| `03-axe-overlay.png` | axe-overlay (54.9 KB) |
| `04-quickpeek-overlay.png` | quickpeek-overlay (74.1 KB) |
| `05-htmlcs-overlay.png` | htmlcs-overlay (54.6 KB) |
| `06-ibm-overlay.png` | ibm-overlay (56.1 KB) |
| `07-structure-overlay.png` | structure-overlay (95.3 KB) |
...
| `15-screenreader-view.png` | screenreader-view (50.0 KB) |
