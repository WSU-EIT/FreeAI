...
|--:|------|:--------:|:---------:|:---:|:---:|:---:|:---:|---------|
| 1 | nested-interactive | serious | medium 1/4 | found | --- | --- | --- | `<div class="nav-scrollable" role="button" tabindex="0" on...` |
| 2 | aria_form_label_unique | serious | medium 1/4 | --- | --- | --- | found | `<form action="/Account/Manage/EnableAuthenticator" method...` |
...
| File | Description |
|------|-------------|
| `01-page-load-00000ms.png` | Page Load +0ms (79.5 KB) |
| `03-axe-overlay.png` | axe-overlay (78.4 KB) |
| `04-quickpeek-overlay.png` | quickpeek-overlay (96.0 KB) |
| `05-htmlcs-overlay.png` | htmlcs-overlay (78.0 KB) |
| `06-ibm-overlay.png` | ibm-overlay (79.4 KB) |
| `07-structure-overlay.png` | structure-overlay (123.1 KB) |
| `07b-wireframe-blueprint.png` | wireframe-blueprint (74.8 KB) |
| `08-cvd-protanopia.png` | cvd-protanopia (85.1 KB) |
| `09-cvd-deuteranopia.png` | cvd-deuteranopia (85.9 KB) |
| `10-cvd-tritanopia.png` | cvd-tritanopia (86.2 KB) |
| `11-cvd-achromatopsia.png` | cvd-achromatopsia (78.1 KB) |
| `12-cvd-protanomaly.png` | cvd-protanomaly (84.7 KB) |
| `13-cvd-deuteranomaly.png` | cvd-deuteranomaly (86.1 KB) |
| `14-cvd-tritanomaly.png` | cvd-tritanomaly (86.4 KB) |
| `15-screenreader-view.png` | screenreader-view (85.2 KB) |
| `16-reduced-motion.png` | reduced-motion (81.9 KB) |
