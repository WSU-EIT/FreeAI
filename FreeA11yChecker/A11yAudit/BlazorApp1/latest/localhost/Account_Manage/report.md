...
|--:|------|:--------:|:---------:|:---:|:---:|:---:|:---:|---------|
| 1 | input_label_before | serious | medium 1/4 | --- | --- | --- | found | `<input style="" disabled="" placeholder="Choose your user...` |
| 2 | nested-interactive | serious | medium 1/4 | found | --- | --- | --- | `<div class="nav-scrollable" role="button" tabindex="0" on...` |
| 3 | aria_form_label_unique | serious | medium 1/4 | --- | --- | --- | found | `<form action="/Account/Manage" method="post">` |
...
| `03-axe-overlay.png` | axe-overlay (51.9 KB) |
| `04-quickpeek-overlay.png` | quickpeek-overlay (70.9 KB) |
| `05-htmlcs-overlay.png` | htmlcs-overlay (51.5 KB) |
| `06-ibm-overlay.png` | ibm-overlay (53.1 KB) |
| `07-structure-overlay.png` | structure-overlay (92.2 KB) |
| `07b-wireframe-blueprint.png` | wireframe-blueprint (45.5 KB) |
| `08-cvd-protanopia.png` | cvd-protanopia (57.6 KB) |
...
| `15-screenreader-view.png` | screenreader-view (49.8 KB) |
