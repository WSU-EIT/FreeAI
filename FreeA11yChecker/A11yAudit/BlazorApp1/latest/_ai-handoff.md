...
- **23** pages scanned
- **123** raw violations across all 4 tools
- **0** IBM PASS-style noise items filtered out at report time
- **123** real violations remaining
...
Aggregate across all 23 scanned pages. **Overall pass rate: 0.0%** (0 of 83 rule checks passed).
...
|---|------|----------|-------|-------------|--------------|
| 1 | `div-button` (htmlcheck) | 🟠 serious | 20/23 | 20 | site-wide (layout) |
| 2 | `aria_eventhandler_role_valid` (ibm) | 🟠 serious | 20/23 | 20 | site-wide (layout) |
| 3 | `aria_form_label_unique` (ibm) | 🟠 serious | 11/23 | 23 | shared component |
| 4 | `input_label_before` (ibm) | 🟠 serious | 10/23 | 18 | shared component |
| 5 | `skip-link` (htmlcheck) | 🟡 moderate | 20/23 | 20 | site-wide (layout) |
| 6 | `aria_content_in_landmark` (ibm) | 🟡 moderate | 20/23 | 20 | site-wide (layout) |
| 7 | `aria_landmark_name_unique` (ibm) | 🟡 moderate | 1/23 | 2 | single page |

## Per-rule fix instructions

### 🟠 `div-button` (htmlcheck) — SERIOUS

- **Pages affected:** 20 of 23
...
- Page: `/`
- Selector: `/html[1]/body[1]/div[1]/div[1]/div[1]/div[1]/a[1]`
- Message: Content is not within a landmark element

```html
<a b-qa4lg9le9h="" href="" class="navbar-brand">
```
