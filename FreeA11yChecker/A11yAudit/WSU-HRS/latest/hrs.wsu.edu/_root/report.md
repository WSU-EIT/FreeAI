...
|--:|------|:--------:|:---------:|:---:|:---:|:---:|:---:|---------|
| 1 | target-size | serious | high 1/4 | found | --- | --- | --- | `<a href="https://hrs.wsu.edu/mission-statement/">Mission ...` |
| 2 | image-alt | serious | low 1/4 | --- | found | --- | --- | `<img height="1" width="1" style="display:none" src="https...` |
| 3 | svg_graphics_labelled | serious | low 1/4 | --- | --- | --- | found | `<svg viewBox="7.481 7.416 50.428 50" height="50" width="5...` |
| 4 | aria_content_in_landmark | moderate | low 1/4 | --- | --- | --- | found | `<a class="screen-reader-shortcut" href="#wsuwp-main">` |
...
| File | Description |
|------|-------------|
| `01-page-load-00000ms.png` | Page Load +0ms (743.5 KB) |
