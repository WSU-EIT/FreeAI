...
| 4 | text_contrast_sufficient | serious | low 1/4 | --- | --- | --- | found | `<strong>` |
| 5 | svg_graphics_labelled | serious | low 1/4 | --- | --- | --- | found | `<svg viewBox="7.481 7.416 50.428 50" height="50" width="5...` |
| 6 | figure_label_exists | moderate | low 1/4 | --- | --- | --- | found | `<figure class="wp-block-media-text__media">` |
| 7 | aria_child_valid | moderate | low 1/4 | --- | --- | --- | found | `<ul class="sub-menu">` |
| 8 | aria_landmark_name_unique | moderate | low 1/4 | --- | --- | --- | found | `<nav class="spine-sitenav" id="spine-sitenav">` |
| 9 | aria_content_in_landmark | moderate | low 1/4 | --- | --- | --- | found | `<a class="screen-reader-shortcut" href="#wsuwp-main">` |
...
| File | Description |
|------|-------------|
| `01-page-load-00000ms.png` | Page Load +0ms (240.6 KB) |
...
| `13-cvd-deuteranomaly.png` | cvd-deuteranomaly (336.3 KB) |
| `14-cvd-tritanomaly.png` | cvd-tritanomaly (337.0 KB) |
| `15-screenreader-view.png` | screenreader-view (320.9 KB) |
| `16-reduced-motion.png` | reduced-motion (335.3 KB) |
| `17-forced-colors.png` | forced-colors (293.3 KB) |
