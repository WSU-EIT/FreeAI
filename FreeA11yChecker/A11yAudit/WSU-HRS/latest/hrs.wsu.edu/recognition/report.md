...
| 3 | https://hrs.wsu.edu/wp-content/uploads/2021/02/los-awards-logo.png | Cougar head logo. |
| 4 | https://hrs.wsu.edu/wp-content/uploads/2021/02/los-awards-logo.png | Cougar head logo. |
| 5 | https://hrs.wsu.edu/wp-content/uploads/2021/02/los-awards-logo.png | Cougar head logo. |
| 6 | https://hrs.wsu.edu/wp-content/uploads/2021/02/QCC-25yr-Coin-HRS.png | QCC logo with the words: Celebrating ... |
| 7 | https://hrs.wsu.edu/wp-content/uploads/2021/02/los-awards-logo.png | Cougar head logo. |
...
|--:|------|:--------:|:---------:|:---:|:---:|:---:|:---:|---------|
| 1 | target-size | serious | high 1/4 | found | --- | --- | --- | `<a href="https://copyright.wsu.edu">©</a>` |
| 2 | aria_navigation_label_unique | serious | low 1/4 | --- | --- | --- | found | `<nav class="spine-sitenav" id="spine-sitenav">` |
| 3 | image-alt | serious | low 1/4 | --- | found | --- | --- | `<img height="1" width="1" style="display:none" src="https...` |
| 4 | svg_graphics_labelled | serious | low 1/4 | --- | --- | --- | found | `<svg viewBox="7.481 7.416 50.428 50" height="50" width="5...` |
| 5 | figure_label_exists | moderate | low 1/4 | --- | --- | --- | found | `<figure class="wp-block-media-text__media">` |
| 6 | aria_child_valid | moderate | low 1/4 | --- | --- | --- | found | `<ul class="sub-menu">` |
| 7 | aria_landmark_name_unique | moderate | low 1/4 | --- | --- | --- | found | `<nav class="spine-sitenav" id="spine-sitenav">` |
| 8 | aria_content_in_landmark | moderate | low 1/4 | --- | --- | --- | found | `<a class="screen-reader-shortcut" href="#wsuwp-main">` |
...
| File | Description |
|------|-------------|
| `01-page-load-00000ms.png` | Page Load +0ms (225.9 KB) |
| `03-axe-overlay.png` | axe-overlay (377.6 KB) |
| `04-quickpeek-overlay.png` | quickpeek-overlay (405.1 KB) |
...
| `11-cvd-achromatopsia.png` | cvd-achromatopsia (344.4 KB) |
| `12-cvd-protanomaly.png` | cvd-protanomaly (383.5 KB) |
| `13-cvd-deuteranomaly.png` | cvd-deuteranomaly (384.3 KB) |
| `14-cvd-tritanomaly.png` | cvd-tritanomaly (383.3 KB) |
| `15-screenreader-view.png` | screenreader-view (311.6 KB) |
| `16-reduced-motion.png` | reduced-motion (377.1 KB) |
| `17-forced-colors.png` | forced-colors (370.9 KB) |
