...
> **URL:** https://financialaid.wsu.edu/how-to-apply/  
> **Status:** ✅ 404  
...
|--:|------|:--------:|:---------:|:---:|:---:|:---:|:---:|---------|
| 1 | image-alt | serious | medium 1/4 | --- | found | --- | --- | `<img height="1" width="1" style="display:none" src="https...` |
| 2 | aria_main_label_unique | serious | medium 1/4 | --- | --- | --- | found | `<main class="wsu-wrapper-main" id="wsu-content" role="main">` |
| 3 | input_checkboxes_grouped | serious | medium 1/4 | --- | --- | --- | found | `<input style="" checked="checked" value="site" name="sear...` |
| 4 | aria_banner_single | serious | medium 1/4 | --- | --- | --- | found | `<header aria-label="WSU system" class="wsu-header-global ...` |
| 5 | table-header | moderate | medium 1/4 | --- | found | --- | --- | `<table cellspacing="0" cellpadding="0" role="presentation...` |
| 6 | fieldset-missing | moderate | medium 1/4 | --- | found | --- | --- | `<input class="wsu-search-options__option-input" type="rad...` |
| 7 | aria_content_in_landmark | moderate | medium 1/4 | --- | --- | --- | found | `<a href="#wsu-site-menu" class="wsu-skip-to-main skip-to-...` |
| 8 | aria_main_label_visible | moderate | medium 1/4 | --- | --- | --- | found | `<body class="error404 wsu-has--mobile-nav wsu-template--">` |
...
| File | Description |
|------|-------------|
| `01-page-load-00000ms.png` | Page Load +0ms (62.9 KB) |
| `03-axe-overlay.png` | axe-overlay (83.1 KB) |
| `04-quickpeek-overlay.png` | quickpeek-overlay (139.1 KB) |
| `05-htmlcs-overlay.png` | htmlcs-overlay (83.5 KB) |
| `06-ibm-overlay.png` | ibm-overlay (84.9 KB) |
| `07-structure-overlay.png` | structure-overlay (143.6 KB) |
| `07b-wireframe-blueprint.png` | wireframe-blueprint (110.4 KB) |
| `08-cvd-protanopia.png` | cvd-protanopia (89.8 KB) |
| `09-cvd-deuteranopia.png` | cvd-deuteranopia (89.8 KB) |
| `10-cvd-tritanopia.png` | cvd-tritanopia (89.4 KB) |
| `11-cvd-achromatopsia.png` | cvd-achromatopsia (90.9 KB) |
| `12-cvd-protanomaly.png` | cvd-protanomaly (91.3 KB) |
| `13-cvd-deuteranomaly.png` | cvd-deuteranomaly (89.9 KB) |
| `14-cvd-tritanomaly.png` | cvd-tritanomaly (91.1 KB) |
| `15-screenreader-view.png` | screenreader-view (199.6 KB) |
| `16-reduced-motion.png` | reduced-motion (88.3 KB) |
| `17-forced-colors.png` | forced-colors (82.4 KB) |
