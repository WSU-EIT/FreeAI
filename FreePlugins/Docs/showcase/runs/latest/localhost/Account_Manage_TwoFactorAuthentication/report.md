...
> **URL:** http://localhost:5104/Account/Manage/TwoFactorAuthentication  
> **Status:** ✅ 404  
...
| 2 | document-title | serious | low 1/4 | found | --- | --- | --- | `<html lang="en" style="--blazor-load-percentage: 100%; --...` |
| 3 | title-missing | serious | low 1/4 | --- | found | --- | --- |  |
| 4 | page_title_exists | serious | low 1/4 | --- | --- | --- | found | `<html style="--blazor-load-percentage: 100%; --blazor-loa...` |
| 5 | skip_main_exists | serious | low 1/4 | --- | --- | --- | found | `<body class="" data-bs-theme="" id="body-element">` |
| 6 | landmark-one-main | moderate | low 1/4 | --- | found | --- | --- |  |
| 7 | landmark-nav | moderate | low 1/4 | --- | found | --- | --- |  |
| 8 | aria_content_in_landmark | moderate | low 1/4 | --- | --- | --- | found | `<h3>` |
...
| File | Description |
|------|-------------|
| `01-page-load-00000ms.png` | Page Load +0ms (13.3 KB) |
| `03-axe-overlay.png` | axe-overlay (12.7 KB) |
| `04-quickpeek-overlay.png` | quickpeek-overlay (20.6 KB) |
| `05-htmlcs-overlay.png` | htmlcs-overlay (12.5 KB) |
| `06-ibm-overlay.png` | ibm-overlay (14.0 KB) |
| `07-structure-overlay.png` | structure-overlay (20.2 KB) |
| `07b-wireframe-blueprint.png` | wireframe-blueprint (12.4 KB) |
| `08-cvd-protanopia.png` | cvd-protanopia (15.7 KB) |
| `09-cvd-deuteranopia.png` | cvd-deuteranopia (15.8 KB) |
| `10-cvd-tritanopia.png` | cvd-tritanopia (15.6 KB) |
| `11-cvd-achromatopsia.png` | cvd-achromatopsia (16.1 KB) |
| `12-cvd-protanomaly.png` | cvd-protanomaly (16.0 KB) |
| `13-cvd-deuteranomaly.png` | cvd-deuteranomaly (16.1 KB) |
| `14-cvd-tritanomaly.png` | cvd-tritanomaly (15.9 KB) |
| `15-screenreader-view.png` | screenreader-view (18.9 KB) |
| `16-reduced-motion.png` | reduced-motion (15.3 KB) |
