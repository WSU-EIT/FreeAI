...
| [runs/2026-05-14/localhost/_root/03-axe-overlay.png](showcase/runs/2026-05-14/localhost/_root/03-axe-overlay.png) | A11y overlay | axe-core (Deque) — 2 violations |
...
| [runs/2026-05-14/localhost/_root/05-htmlcs-overlay.png](showcase/runs/2026-05-14/localhost/_root/05-htmlcs-overlay.png) | A11y overlay | HTML_CodeSniffer — 0 issues |
| [runs/2026-05-14/localhost/_root/06-ibm-overlay.png](showcase/runs/2026-05-14/localhost/_root/06-ibm-overlay.png) | A11y overlay | IBM Equal Access — 7 issues |
...
| [runs/2026-05-14/localhost/_root/a11y-summary.json](showcase/runs/2026-05-14/localhost/_root/a11y-summary.json) | Report | Combined a11y summary — 13 total violations |
