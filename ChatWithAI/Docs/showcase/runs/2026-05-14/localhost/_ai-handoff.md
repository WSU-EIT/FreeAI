...
**Generated:** 2026-05-14 14:02:42  
**Source root:** *(not provided — no source cross-references)*  
**Scan output:** `C:\Users\pepkad\source\repos\WSU-EIT\FreeAI\ChatWithAI\Docs\showcase\runs\2026-05-14\localhost`  

## Summary

- **1** pages scanned
- **13** raw violations across all 4 tools
- **0** IBM PASS-style noise items filtered out at report time
- **13** real violations remaining
...
Aggregate across all 1 scanned pages. **Overall pass rate: 0.0%** (0 of 7 rule checks passed).
...
| 3 | `aria_content_in_landmark` (ibm) | 🟡 moderate | 1/1 | 4 | site-wide (layout) |
| 4 | `heading-empty` (htmlcheck) | 🟡 moderate | 1/1 | 2 | site-wide (layout) |
| 5 | `skip-link` (htmlcheck) | 🟡 moderate | 1/1 | 1 | site-wide (layout) |
| 6 | `landmark-main` (htmlcheck) | 🟡 moderate | 1/1 | 1 | site-wide (layout) |
| 7 | `aria_child_valid` (ibm) | 🟡 moderate | 1/1 | 1 | site-wide (layout) |
