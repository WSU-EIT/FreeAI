...
CLI runs are captured by redirecting stdout to a transcript file:
`
dotnet run --project {PROJECT} [args] > Docs/showcase/runs/run-2026-05-14.txt
`

> **Status:** No runs captured yet. Populate Docs/showcase/runs/ with representative runs.
