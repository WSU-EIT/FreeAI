...
Example code and its output are saved here as Markdown files.
Each file shows a scenario, the code, and the captured output.

> **Status:** No examples captured yet. Add representative usage scenarios to Docs/showcase/examples/.
