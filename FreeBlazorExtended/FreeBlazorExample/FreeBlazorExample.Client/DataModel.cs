...
#region Enumerations and Data Objects used by FreeBlazorExample
...
public partial class BlazorDataModel
{
    ...
    // Stub properties for removed modules (preserved so legacy razor markup compiles).
    public bool FeatureEnabledLocation => false;
    public bool FeatureEnabledScheduling => false;
    public bool FeatureEnabledServices => false;
    public bool FeatureEnabledInvoices => false;
    public bool FeatureEnabledEmailTemplates => false;
    public bool AllowUsersToManageLocation => false;
