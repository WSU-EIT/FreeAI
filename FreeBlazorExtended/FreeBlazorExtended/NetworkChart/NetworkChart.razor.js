/*
    Purpose: JavaScript interop host for the NetworkChart component.
    Fits: Creates and updates the vis.js network instance, applies layout options, and forwards selection events to Blazor.
*/
var chartData = null;
var container = null;
var dotNetHelper;
...
export function ChartRender(elementId, data, solver, seed, startNodeId) {
    ...
    network.on("select", function (e) {
        try {
            ...
            if (node != "") {
                if (dotNetHelper) dotNetHelper.invokeMethod("ElementSelected", node.toString());
                return;
            }
            ...
            if (edge != "") {
                if (dotNetHelper) dotNetHelper.invokeMethod("RelationshipSelected", edge.toString());
            }
        } catch (e) {
