...
public partial class FormService
{
    ...
    public Task<bool> IsFieldVisible(FormField field, Dictionary<Guid, string?> currentValues)
    {
    ...
    public Task<List<string>> ValidateSubmission(FormDefinition formDef, Dictionary<Guid, string?> fieldValues)
    {
