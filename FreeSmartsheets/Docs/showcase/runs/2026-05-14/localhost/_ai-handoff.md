...
**Generated:** 2026-05-14 14:13:47  
**Source root:** *(not provided — no source cross-references)*  
**Scan output:** `C:\Users\pepkad\source\repos\WSU-EIT\FreeAI\FreeSmartsheets\Docs\showcase\runs\2026-05-14\localhost`  

## Summary

- **1** pages scanned
- **10** raw violations across all 4 tools
- **0** IBM PASS-style noise items filtered out at report time
- **10** real violations remaining
...
| 4 | `aria_content_in_landmark` (ibm) | 🟡 moderate | 1/1 | 2 | site-wide (layout) |
